...
export function normalizeCarListing(payload: unknown): CarListing | null {
  ...
  const listing: CarListing = {
    ...
    available_locales: Array.isArray(source.available_locales)
      ...
      : undefined,
    brand_id: toString(source.brand_id) || undefined,
    brand_slug: toString(source.brand_slug) || undefined,
    brand,
    model_id: toString(source.model_id) || undefined,
    model_slug: toString(source.model_slug) || undefined,
    model,
    ...
    city_id: toString(source.city_id) || undefined,
    city_slug: toString(source.city_slug) || undefined,
    city: toString(source.city),
    region_id: toString(source.region_id) || undefined,
    region_slug: toString(source.region_slug) || undefined,
    region: toString(source.region || source.state) || undefined,
    postal_code: toString(source.postal_code || source.zip_code || source.postcode) || undefined,
