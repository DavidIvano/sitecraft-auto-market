...
export const BACKEND_ROUTES_REQUIRING_XANO_WORK = [
  ...
  "GET /deal-finder/listings/{id}/workspace",
  "PATCH /deal-finder/listings/{id}/workspace",
  "GET /deal-finder/comparison",
  "PATCH /deal-finder/comparison",
  "GET /deal-finder/notifications/preferences",
  "PATCH /deal-finder/notifications/preferences",
  "GET /deal-finder/notifications/deliveries",
  "GET /deal-finder/sync-logs",
  "POST /purchases/create",
  "POST /purchases/apply",
  "GET /me/purchases",
  "GET /dealer-profile",
  "POST /dealer-profile/update",
  "GET /admin/dealers",
