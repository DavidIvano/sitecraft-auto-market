...
const rawDefinitions: LocaleDefinition[] = [
  ...
  { code: "ar", baseLanguage: "ar", nativeName: "العربية", englishName: "Arabic", direction: "rtl", fallbackLocale: "en", isActive: true, isPublic: false, isDefault: false, sortOrder: 60 },
  ...
  { code: "bg", baseLanguage: "bg", nativeName: "Български", englishName: "Bulgarian", direction: "ltr", fallbackLocale: "en", isActive: true, isPublic: false, isDefault: false, sortOrder: 100 },
  { code: "hr", baseLanguage: "hr", nativeName: "Hrvatski", englishName: "Croatian", direction: "ltr", fallbackLocale: "en", isActive: true, isPublic: false, isDefault: false, sortOrder: 110 },
  { code: "cs", baseLanguage: "cs", nativeName: "Čeština", englishName: "Czech", direction: "ltr", fallbackLocale: "en", isActive: true, isPublic: false, isDefault: false, sortOrder: 120 },
  { code: "da", baseLanguage: "da", nativeName: "Dansk", englishName: "Danish", direction: "ltr", fallbackLocale: "en", isActive: true, isPublic: false, isDefault: false, sortOrder: 130 },
  ...
  { code: "it", baseLanguage: "it", nativeName: "Italiano", englishName: "Italian", direction: "ltr", fallbackLocale: "en", isActive: true, isPublic: false, isDefault: false, sortOrder: 210 },
  { code: "lv", baseLanguage: "lv", nativeName: "Latviešu", englishName: "Latvian", direction: "ltr", fallbackLocale: "en", isActive: true, isPublic: false, isDefault: false, sortOrder: 220 },
  { code: "lt", baseLanguage: "lt", nativeName: "Lietuvių", englishName: "Lithuanian", direction: "ltr", fallbackLocale: "en", isActive: true, isPublic: false, isDefault: false, sortOrder: 230 },
  { code: "mt", baseLanguage: "mt", nativeName: "Malti", englishName: "Maltese", direction: "ltr", fallbackLocale: "en", isActive: true, isPublic: false, isDefault: false, sortOrder: 240 },
  { code: "pl", baseLanguage: "pl", nativeName: "Polski", englishName: "Polish", direction: "ltr", fallbackLocale: "en", isActive: true, isPublic: false, isDefault: false, sortOrder: 250 },
  { code: "pt", baseLanguage: "pt", nativeName: "Português", englishName: "Portuguese", direction: "ltr", fallbackLocale: "en", isActive: true, isPublic: false, isDefault: false, sortOrder: 260 },
  { code: "ro", baseLanguage: "ro", nativeName: "Română", englishName: "Romanian", direction: "ltr", fallbackLocale: "en", isActive: true, isPublic: false, isDefault: false, sortOrder: 270 },
  { code: "sk", baseLanguage: "sk", nativeName: "Slovenčina", englishName: "Slovak", direction: "ltr", fallbackLocale: "en", isActive: true, isPublic: false, isDefault: false, sortOrder: 280 },
  { code: "sl", baseLanguage: "sl", nativeName: "Slovenščina", englishName: "Slovenian", direction: "ltr", fallbackLocale: "en", isActive: true, isPublic: false, isDefault: false, sortOrder: 290 },
  { code: "es", baseLanguage: "es", nativeName: "Español", englishName: "Spanish", direction: "ltr", fallbackLocale: "en", isActive: true, isPublic: false, isDefault: false, sortOrder: 300 },
  { code: "sv", baseLanguage: "sv", nativeName: "Svenska", englishName: "Swedish", direction: "ltr", fallbackLocale: "en", isActive: true, isPublic: false, isDefault: false, sortOrder: 310 },
];
